...
public class AccountTransactionTest {
    ...
    public void directedTransactionWorks() throws Exception, UnableToPostException, MismatchedCurrencyException, ImmutableEntryException {
        ...
        payForBillBoards.addEntry(CREDIT,HardCash.shilling(32),vat,"VAT for billBoards");
        payForBillBoards.addEntry(CREDIT,HardCash.shilling(168),chequeAccount,"CHQ IFO Billboards Ltd");
        ...
        reimbursement.addEntry(CREDIT,HardCash.shilling(150), edwinsAccount,"Reimbursement for meeting expenses with billboard guys");
