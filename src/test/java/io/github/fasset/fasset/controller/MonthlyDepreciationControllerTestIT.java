...
public class MonthlyDepreciationControllerTestIT {
    ...
    public void goToAssetMonthlyDepreciationWorks() throws Exception {
        this.mockMvc.perform(get("/reports/depreciations/assets"))
                .andExpect(status().isOk())
                .andExpect(view().name("reports/monthlyAsset"))
                .andDo(print());
    }

    @Test
    public void goToSolMonthlyDepreciationWorks() throws Exception {
        this.mockMvc.perform(get("/reports/depreciations/sols"))
                .andExpect(status().isOk())
                .andExpect(view().name("reports/monthlySol"))
                .andDo(print());
    }

    @Test
    public void goToCategoryMonthlyDepreciationWorks() throws Exception {
        this.mockMvc.perform(get("/reports/depreciations/categories"))
                .andExpect(status().isOk())
                .andExpect(view().name("reports/monthlyCategory"))
                .andDo(print());
    }
    ...
    public void monthlyAssetDepreciationDataWorks() throws Exception {
        ...
        assetDepreciation1.setAssetId(20)
                .setYear(2018)
                .setJan(101.0)
                .setFeb(102.1)
                .setMar(103.2)
        ...
        assetDepreciation2.setAssetId(21)
                .setYear(2018)
                .setJan(201.0)
                .setFeb(202.1)
                .setMar(203.2)
        ...
        this.mockMvc.perform(get("/reports/depreciations/assets/data"))
                ...
                .andExpect(jsonPath("$[0].feb", is(assetDepreciation1.getFeb())))
                .andExpect(jsonPath("$[0].mar", is(assetDepreciation1.getMar())))
                .andExpect(jsonPath("$[0].apr", is(assetDepreciation1.getApr())))
                .andExpect(jsonPath("$[0].may", is(assetDepreciation1.getMay())))
                .andExpect(jsonPath("$[0].jun", is(assetDepreciation1.getJun())))
                .andExpect(jsonPath("$[0].jul", is(assetDepreciation1.getJul())))
                .andExpect(jsonPath("$[0].aug", is(assetDepreciation1.getAug())))
                .andExpect(jsonPath("$[0].sep", is(assetDepreciation1.getSep())))
                ...
                .andExpect(jsonPath("$[1].assetId", is(assetDepreciation2.getAssetId())))
                .andExpect(jsonPath("$[1].year", is(assetDepreciation2.getYear())))
                .andExpect(jsonPath("$[1].jan", is(assetDepreciation2.getJan())))
                .andExpect(jsonPath("$[1].feb", is(assetDepreciation2.getFeb())))
                .andExpect(jsonPath("$[1].mar", is(assetDepreciation2.getMar())))
                .andExpect(jsonPath("$[1].apr", is(assetDepreciation2.getApr())))
                .andExpect(jsonPath("$[1].may", is(assetDepreciation2.getMay())))
                .andExpect(jsonPath("$[1].jun", is(assetDepreciation2.getJun())))
                .andExpect(jsonPath("$[1].jul", is(assetDepreciation2.getJul())))
                .andExpect(jsonPath("$[1].aug", is(assetDepreciation2.getAug())))
                .andExpect(jsonPath("$[1].sep", is(assetDepreciation2.getSep())))
                .andExpect(jsonPath("$[1].oct", is(assetDepreciation2.getOct())))
                .andExpect(jsonPath("$[1].nov", is(assetDepreciation2.getNov())))
                .andExpect(jsonPath("$[1].dec", is(assetDepreciation2.getDec())))
                .andDo(print());
    }
}