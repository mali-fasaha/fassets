...
public class BriefControllerTestIT {
    ...
    public void getServiceOutletBriefsTemplateWorks() throws Exception {
        this.mockMvc.perform(get("/briefs/serviceOutlets"))
                .andExpect(status().isOk())
                .andExpect(view().name("briefs/serviceOutletBriefs"))
                .andDo(print());
    }
    ...
    public void getCategoryGivenIdWorks() throws Exception {
        ...
        this.mockMvc.perform(get("/briefs/categories/data/{nomenclature}",id))
                .andExpect(status().isOk())
                .andExpect(content().contentType(TestUtil.APPLICATION_JSON_UTF8))
                .andExpect(jsonPath("nomenclature",is(id)))
                .andExpect(jsonPath("poll",is(20)))
                .andExpect(jsonPath("designation",is("Computers")))
                .andExpect(jsonPath("netBookValue",is(6800.0)))
                .andExpect(jsonPath("purchaseCost",is(7100.0)))
                .andDo(print());
    }
    ...
    public void getCategoryBriefsWorks() throws Exception {
        ...
        this.mockMvc.perform(get("/briefs/categories/data"))
                .andExpect(status().isOk())
                .andExpect(content().contentType(TestUtil.APPLICATION_JSON_UTF8))
                .andExpect(jsonPath("$",hasSize(2)))
                .andExpect(jsonPath("$[0].nomenclature",is(id)))
                .andExpect(jsonPath("$[0].poll",is(brief1.getPoll())))
                .andExpect(jsonPath("$[0].designation",is(brief1.getDesignation())))
                .andExpect(jsonPath("$[0].netBookValue",is(brief1.getNetBookValue().getNumber().doubleValue())))
                .andExpect(jsonPath("$[0].purchaseCost",is(brief1.getPurchaseCost().getNumber().doubleValue())))
                .andExpect(jsonPath("$[1].nomenclature",is(id2)))
                .andExpect(jsonPath("$[1].poll",is(brief2.getPoll())))
                .andExpect(jsonPath("$[1].designation",is(brief2.getDesignation())))
                .andExpect(jsonPath("$[1].netBookValue",is(brief2.getNetBookValue().getNumber().doubleValue())))
                .andExpect(jsonPath("$[1].purchaseCost",is(brief2.getPurchaseCost().getNumber().doubleValue())))
                .andDo(print());
    ...
    public void getServiceOutletBriefGivenIdWorks() throws Exception {
        ...
        this.mockMvc.perform(get("/briefs/serviceOutlets/data/{nomenclature}",id))
                .andExpect(status().isOk())
                .andExpect(content().contentType(TestUtil.APPLICATION_JSON_UTF8))
                .andExpect(jsonPath("nomenclature",is(id)))
                .andExpect(jsonPath("poll",is(solBrief1.getPoll())))
                .andExpect(jsonPath("designation",is(solBrief1.getDesignation())))
                .andExpect(jsonPath("purchaseCost",is(7000.0)))
                .andExpect(jsonPath("netBookValue",is(6500.0)))
                .andDo(print());
    }
    ...
    public void getServiceOutletBriefsWorks() throws Exception {
        ...
        this.mockMvc.perform(get("/briefs/serviceOutlets/data"))
                .andExpect(status().isOk())
                .andExpect(content().contentType(TestUtil.APPLICATION_JSON_UTF8))
                .andExpect(jsonPath("$",hasSize(2)))
                .andExpect(jsonPath("$[0].nomenclature",is(id)))
                .andExpect(jsonPath("$[0].poll",is(solBrief1.getPoll())))
                .andExpect(jsonPath("$[0].designation",is(solBrief1.getDesignation())))
                .andExpect(jsonPath("$[0].purchaseCost",is(solBrief1.getPurchaseCost().getNumber().doubleValue())))
                .andExpect(jsonPath("$[0].netBookValue",is(solBrief1.getNetBookValue().getNumber().doubleValue())))
                .andExpect(jsonPath("$[1].nomenclature",is(id2)))
                .andExpect(jsonPath("$[1].poll",is(solBrief2.getPoll())))
                .andExpect(jsonPath("$[1].designation",is(solBrief2.getDesignation())))
                .andExpect(jsonPath("$[1].purchaseCost",is(solBrief2.getPurchaseCost().getNumber().doubleValue())))
                .andExpect(jsonPath("$[1].netBookValue",is(solBrief2.getNetBookValue().getNumber().doubleValue())))
                .andDo(print());
    }
}