...
public class DefaultAccountIDResolver implements AccountIDResolver {
    ...
    public String resolveContraAccountId(FixedAsset fixedAsset) {
        ...
        return String.format("Accumulated Depreciation on %s", fixedAsset.getCategory());
    }
     ...
     */
    @Override
    public String resolveGeneralLedgerId(FixedAsset fixedAsset) {
        return null;
    }
