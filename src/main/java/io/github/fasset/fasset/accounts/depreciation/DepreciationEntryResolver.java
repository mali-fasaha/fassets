...
/**
 * This is interface is similar with the BatchEntryResolver however the depreciation concept must have Effective period and such was lacking in that interface. A new interface must therefore be
