...
/**
 * Reads data from a list generated by an excel row mapper. <br> Please note the row here spoken of is not the physical row of and excel file but the data already extracted from such an excel file
 * into a data structure <br> The distinction is like the dark and the bright side of the moon, when you consider that the entire data set will be flooding the memory, before the list is ready
