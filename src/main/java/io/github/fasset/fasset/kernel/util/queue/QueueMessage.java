 ...
 * simultaneously enqueue an object of any type. <br> The 'consumer' on the other hand has only to call the {@link QueueMessage#message()} method to obtain the message sent by the producer. <br> The
 * consumer for the {@link FileUploadService} consumption of the message might look as follows:
