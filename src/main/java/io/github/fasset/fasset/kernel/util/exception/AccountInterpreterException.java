package io.github.fasset.fasset.kernel.util.exception;
...
/**
 * This exception is a custom runtime exception thrown when the AccountInterpreter is trying to post
 * transactions into Accounts.
 */
public class AccountInterpreterException extends RuntimeException {

    /**
     * Creates an AccountInterpreterException a RuntimeException using details of the number of entries
     * being posted, the transaction an the Exception itself
     *
     ...
     */
    public AccountInterpreterException(final List<AccountingEntry> entries, final Transaction transaction, final Exception e) {
