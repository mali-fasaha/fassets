 ...
 * FileSystemStorageService#store(file)} method. The file having been stored in the file system the service then calls the {@link MessageQueue#push(QueueMessage, OnError, OnCompletion)} method to
