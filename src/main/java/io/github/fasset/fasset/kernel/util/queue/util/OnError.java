 ...
 * FileSystemStorageService#store(file)} method. The file having been stored in the file system the service then calls the {@link io.github.fasset.fasset.kernel.util.queue.MessageQueue#push
 * (QueueMessage,
 * * OnError, OnCompletion)} method to notify the system of this event for future detached asynchronous processing.
